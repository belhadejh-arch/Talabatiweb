...
export default function AdminSettings() {
  ...
  return <div className="max-w-2xl space-y-6"><h2 className="text-2xl font-bold">الإعدادات</h2>
    ...
    <Card><CardHeader><CardTitle>تكامل واتساب والمنصة</CardTitle></CardHeader><CardContent className="space-y-4">
      ...
      <Button onClick={() => updateSettings.mutate({ data: { whatsappPhoneId: phoneId || settings?.whatsappPhoneId, whatsappEnabled: enabled } })} disabled={updateSettings.isPending}>حفظ الإعدادات</Button>
    </CardContent></Card>
  </div>;
}